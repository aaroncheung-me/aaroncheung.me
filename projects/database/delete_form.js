async function deleteCustomer() {
    try {
        ...
        const customersResponse = await fetch('projects/database/api.php?action=get_customers');
...
async function handleDeleteSubmit(e) {
    ...
    try {
        ...
        const response = await fetch('projects/database/api.php?action=delete_customer', {
            method: 'POST',
            headers: {
